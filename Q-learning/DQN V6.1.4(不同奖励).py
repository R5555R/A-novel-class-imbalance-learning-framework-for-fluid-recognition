...
print(np.mean(precision_score(Y_test, y_predictions, average=None)))
print(np.mean(recall_score(Y_test, y_predictions, average=None)))
print(np.mean(f1_score(Y_test, y_predictions, average=None)))
# from sklearn.metrics import confusion_matrix
# import seaborn as sns
# import matplotlib.pyplot as plt
